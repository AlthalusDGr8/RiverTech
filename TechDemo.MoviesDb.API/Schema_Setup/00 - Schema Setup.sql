USE [master]
GO
/****** Object:  Database [TechDemo.MoviesDb]    Script Date: 14/12/2021 23:03:40 ******/
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = N'TechDemo.MoviesDb')
BEGIN
CREATE DATABASE [TechDemo.MoviesDb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TechDemo.MoviesDb', FILENAME = N'C:\Users\t_cas\TechDemo.MoviesDb.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TechDemo.MoviesDb_log', FILENAME = N'C:\Users\t_cas\TechDemo.MoviesDb_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
END
GO
ALTER DATABASE [TechDemo.MoviesDb] SET COMPATIBILITY_LEVEL = 130
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [TechDemo.MoviesDb].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [TechDemo.MoviesDb] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET ARITHABORT OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET  DISABLE_BROKER 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET  MULTI_USER 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [TechDemo.MoviesDb] SET DB_CHAINING OFF 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [TechDemo.MoviesDb] SET QUERY_STORE = OFF
GO
...
USE [TechDemo.MoviesDb]
GO
/****** Object:  Schema [Movies]    Script Date: 14/12/2021 23:03:40 ******/
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'Movies')
EXEC sys.sp_executesql N'CREATE SCHEMA [Movies]'
GO
/****** Object:  Table [Movies].[GenreMovie]    Script Date: 14/12/2021 23:03:40 ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  Table [Movies].[LK_Genres]    Script Date: 14/12/2021 23:03:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [Movies].[Movies]    Script Date: 14/12/2021 23:03:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
USE [master]
GO
ALTER DATABASE [TechDemo.MoviesDb] SET  READ_WRITE 
GO
